    ...
    .then((data) => {
        ...
        function showCards(array) {
            ...
            array.forEach((annuncio, i) => {
                ...
                div.innerHTML = `
                    <img src="https://picsum.photos/${300 + i}/200" alt="immagine casuale" class="img-fluid img-card">
        ...
        function filterByCategory(array) {
            let checked = Array.from(radioButtons).find((button) => button.checked);
        ...
        function setPriceInput() {
            let prices = filterByCategory(data).map((annuncio) => Number(annuncio.price));
            prices.sort((a, b) => a - b);
